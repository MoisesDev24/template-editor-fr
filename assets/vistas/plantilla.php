    ...
    <div id="seccion_inicial">
            ...
            <nav class="navbar" id="navbar">
                <div class="navbar_contenedor_uno">
                    ...
                    if (!empty($datos_plantilla['logo_t'])) {
                        ...
                        echo '
                                <a href="https://plateforme.kalstein.net/template-editor/assets/vistas/datosTienda.php" class="btn_inicio_2 efecto_edit" title="Ajoutez votre logo ici">
                                    <figure class="navbar_img">
            ...
            <div class="contenedor_form_buscador">
                <form action="" method="GET" class="form_buscador formulario_ajax">
                    <input type="search" name="buscador"
                        placeholder="Rechercher par référence, catalogue, produit, mot-clé ou marque..."
            ...
            <div class="banner">
                <figure class="banner_img">
                    ...
                    if (!empty($datos_plantilla['titulo_t']) && empty($datos_plantilla['banner_t'])) {
                        ...
                        echo '
                                <a href="https://plateforme.kalstein.net/template-editor/assets/vistas/imagenes.php#banner_p" class="efecto_edit" title="Agrega un Banner aquí">
                                    <h1 class="titulo_principal" style="color: ' . (isset($color_p) ? $color_p : 'var(--color-primario)') . ';">
                                        Title de la boutique
                                    </h1>
                                    <img src="../img/banner-2.png" alt="Banner">
        ...
        <main class="contenedor_principal">
            ...
            if (isset($datos_plantilla['titulo_t']) && !empty($datos_plantilla['titulo_t'])) {
                ...
                echo '
                        <a href="https://plateforme.kalstein.net/template-editor/assets/vistas/datosTienda.php#descripcion_tienda" class="btn_contenedor_tienda" title="Ajouter a Title and Description here.">
                            <h1 class="titulo_extra" style="color: ' . (isset($color_p) ? $color_p : 'var(--color-primario)') . ';">
                            Short Boutique Description
                            </h1>
                            <p class="descripcion_corta">
                                ' . $descripcion_t . '
                            </p>
            ...
            Découvrez nos <strong style="color: <?php if (isset($color_p)) {
                    echo $color_p;
                } else {
            ...
            <div class="contenedor_item_doble">
                ...
                if (mysqli_num_rows($consulta_productos_limit) > 0) {
                    ...
                    echo '
                            <div class="item_doble elementoScroll">
                                <a href="https://plateforme.kalstein.net/distribuidor/productos/agregar/" class="item_doble_enlace efecto_edit" title="Ajoutez un produit ici">
                                    <figure class="item_doble_img">
                                ...
                                <div class="item_informacion">
                                    <a href="https://plateforme.kalstein.net/distribuidor/productos/agregar/" class="efecto_edit" title="Ajoutez un produit ici">
                                        <h2>Producto 1</h2>
                                    </a>
                                    ...
                                    <div class="separador_boton_precio">
                                        <a href="https://plateforme.kalstein.net/distribuidor/productos/agregar/" class="boton_ver_mas">
                                            Ajouter
                ...
                if (mysqli_num_rows($consulta_prod_indiv) > 0) {
                        ...
                        echo '
                                <div class="item_individual elementoScroll">
                                    <div class="item_informacion_individual">
                                        <div>
                                            <h2>' . addslashes($datos_prod_indiv["product_name_fr"]) . '</h2>';
                    ...
                    echo '
                            <div class="item_individual elementoScroll">
                                <div class="item_informacion_individual">
                                    <div>
                                        <a href="https://plateforme.kalstein.net/distribuidor/productos/agregar/" class="btn_agg_prod efecto_edit" title="Ajoutez un produit ici">
                                            <h2>Producto 3</h2>
                                        </a>
                                        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Inventore dolore accusamus esse itaque amet, aperiam quis delectus ut ipsum, officiis earum nobis adipisci, illum quas? Rem quis nemo eos hic.</p>
                                        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Inventore dolore accusamus esse itaque amet, aperiam quis delectus ut ipsum, officiis earum nobis adipisci, illum quas? Rem quis nemo eos hic.</p>
                                ...
                                <a href="https://plateforme.kalstein.net/distribuidor/productos/agregar/" class="item_individual_enlace efecto_edit" title="Ajoutez un produit ici">
                                    <figure class="item_individual_img">
                                        <img src="../img/banner-default.png" alt="item">
                                    </figure>
                                </a>
            ...
            <h2 class="titulo_secundario">
                Produits <strong style="color: <?php if (isset($color_p)) {
                    echo $color_p;
                } else {
                    echo 'var(--color-primario)';
                } ?>;">Carrousel</strong>
            ...
            <div class="carousel">
                <div class="carousel_wrapper">
                    ...
                    if (mysqli_num_rows($consulta_productos_img) > 0) {
                        ...
                        echo '
                                <a href="https://plateforme.kalstein.net/distribuidor/productos/agregar/" class="carousel_contenedor_imagen efecto_edit" title="Ajoutez un produit ici">
                                    <figure>
            ...
            <h2 class="titulo_secundario fondo_titulo">
                ...
                if (isset($datos_plantilla['subtitulo_t']) && !empty($datos_plantilla['subtitulo_t'])) {
                    ...
                    echo '
                            <a href="https://plateforme.kalstein.net/template-editor/assets/vistas/datosTienda.php#subtitulo_tienda" class="btn_titulo_tienda efecto_edit" title="Ajoutez un sous-titre ici">
                                Titre Secondaire de Votre Boutique!
                            </a>
                        ';
                } else {
                ...
                if (mysqli_num_rows($consulta_productos_img_dos) > 0) {
                        ...
                        echo '
                                <div class="contenedor_img_individual">
                                    <figure class="img_individual">
                                        <img src="' . $datos_prod_img["product_image"] . '" alt="Extra Produits">
                                    </figure>
                    ...
                    echo '
                            ...
                            <div class="contenedor_img_individual">
                                ...
                                <a href="https://plateforme.kalstein.net/distribuidor/productos/agregar/" class="img_individual_enlace" title="Ajoutez un produit ici">
                                    Ajouter
                                    <svg class="icono_ver_mas-white" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 448 512">
                                        <path d="M438.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L338.8 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l306.7 0L233.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l160-160z"/>
                                    </svg>
            ...
            <div class="contenedor_info">
                <h2 class="titulo_secundario">
                Enterprise<strong style="color: <?php if (isset($color_p)) {
                        echo $color_p;
                    } else {
                        echo 'var(--color-primario)';
                    } ?>;"> Information</strong>
                ...
                <div class="historia elementoScroll">
                    ...
                    if (isset($datos_plantilla['quienes_somos_t']) && !empty($datos_plantilla['quienes_somos_t'])) {
                        ...
                        echo '
                                <a href="https://plateforme.kalstein.net/template-editor/assets/vistas/datosTienda.php#quienes_somos" class="btn_contenedor_tienda_dos" title="Ajoutez lidentité de votre entreprise ici">
                    ...
                    <figure class="historia_img">
                        ...
                        if (!empty($datos_plantilla['img_quienes_s'])) {
                            ...
                            echo '
                                    <a href="https://plateforme.kalstein.net/template-editor/assets/vistas/imagenes.php#quienes_somos_t" class="efecto_edit" title="Ajoutez une image ici">
                ...
                <div class="mision elementoScroll">
                    ...
                    if (isset($datos_plantilla['mision']) && !empty($datos_plantilla['mision'])) {
                        ...
                        echo '
                                <a href="https://plateforme.kalstein.net/template-editor/assets/vistas/datosTienda.php#mision_tienda" class="btn_contenedor_tienda_dos" title="Ajouter Notre Mission d Entreprise Here">
                    ...
                    <figure class="mision_img">
                        ...
                        if (!empty($datos_plantilla['img_mision'])) {
                            ...
                            echo '
                                    <a href="https://plateforme.kalstein.net/template-editor/assets/vistas/imagenes.php#mision_img" class="efecto_edit" title="Ajoutez une image ici">
                                        <img src="../img/banner-default.png" alt="imagen_empresa">
                                    </a>
                                ';
                        } else {
                ...
                <div class="vision elementoScroll">
                    ...
                    if (isset($datos_plantilla['vision']) && !empty($datos_plantilla['vision'])) {
                        echo '
                                <div class="vision_datos">
                                    <h2>Notre Vision d Entreprise</h2>
                                    <p>' . $datos_plantilla['vision'] . '</p>
                                </div>
                            ';
                    } elseif ($tipo_usuario['account_rol_aid'] == 2 || $tipo_usuario['account_rol_aid'] == 3 || $tipo_usuario['account_rol_aid'] == 4) {
                        echo '
                                <a href="https://plateforme.kalstein.net/template-editor/assets/vistas/datosTienda.php#vision_tienda" class="btn_contenedor_tienda_dos" title="Ajouter Your Business Vision Here">
                    ...
                    <figure class="vision_img">
                        ...
                        if (!empty($datos_plantilla['img_vision'])) {
                            ...
                            echo '
                                    <a href="https://plateforme.kalstein.net/template-editor/assets/vistas/imagenes.php#imagen_vision" class="efecto_edit" title="Ajoutez une image ici">
                                        <img src="../img/banner-default.png" alt="imagen_empresa">
                                    </a>
                                ';
                        } else {
            ...
            if ($showButton) {
                echo '
                        <a href="../../dashboard.php" class="btn_dashboard">
                            <span>Retournez à l éditeur</span>
                        </a>
                    ...
                    if (mysqli_num_rows($consulta_render_products) > 0) {
                        while ($datos_producto = mysqli_fetch_array($consulta_render_products)) {
                            ...
                            if (!empty($datos_producto["resultado_renderP"])) {
                                ...
                                echo '
                                    <a href="https://plateforme.kalstein.net/template-editor/assets/vistas/products3d.php" class="btn_render_product btn_to_render">
                                    Rendre ce produit en 3D
                                    </a>
                                ';
                            }
                            ...
                            echo '
                                                <div class="contenedor_boton_ver_mas">
                                                    <a href="https://plateforme.kalstein.net/account_redirect/?search=' . $datos_producto["product_model"] . '" class="boton_ver_mas btn_cotizar">
                                                        <span>Citation</span>
                                                        <svg class="icono_ver_mas" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 448 512">
                        ...
                        if ($tipo_usuario['account_rol_aid'] == 2 || $tipo_usuario['account_rol_aid'] == 3 || $tipo_usuario['account_rol_aid'] == 4) {
                            echo '
                                    <span class="subirtext">You havent uploaded any Produits</span>
                                    <a href="https://plateforme.kalstein.net/distribuidor/productos/agregar/" class="btn_agregar_producto" title="Ajoutez un produit ici">
                                        Ajouter a Produits!
                                    </a>
                                ';
                        } else {
