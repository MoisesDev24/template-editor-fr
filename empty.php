...
<head>
    ...
    <link rel="icon" href="https://plateforme.kalstein.net/template-editor/assets/img/favicon/favicon.ico" type="image/x-icon">
...
<body>
    ...
    <div id="seccion_inicial">
        <header class="cabecera">
                ...
                <div class="modal_dropdown">
                    <div class="dropdown">
                        <ul class="dropdown_lista">
                            ...
                            <li class="navbar_item_drop"><a href="#" class="btn_productos"><span>Produits</span></a></li>
                        </ul>
                    </div>
            ...
            <div class="contenedor_form_buscador">
                <form action="" method="GET" class="form_buscador formulario_ajax">
                    <input type="search" name="buscador" placeholder="Recherchez par référence, catalogue, produit, mot-clé ou marque..." class="buscador_input" required>
        ...
        <main class="contenedor_principal">
            ...
            Explorez nos  <strong style="color: <?php if(isset($color_p)){echo $color_p;}else{echo 'var(--color-primario)';} ?>;">Produits</strong>!
            </h2>
            ...
            <h2 class="titulo_secundario">
                Carrousel de <strong style="color: <?php if(isset($color_p)){echo $color_p;}else{echo 'var(--color-primario)';} ?>;">produits</strong>
            </h2>
            ...
            <div class="contenedor_info">
                <h2 class="titulo_secundario">
                Informations sur <strong style="color: <?php if(isset($color_p)){echo $color_p;}else{echo 'var(--color-primario)';} ?>;"> l'entreprise</strong>
                </h2>
                            ...
                            while ($datos_producto = mysqli_fetch_array($consulta_render_products)) {
                                ...
                                echo '
                                                <div class="contenedor_boton_ver_mas">
                                                    <a href="https://plateforme.kalstein.net/sinscrire/?search='.$datos_producto["product_model"].'" class="boton_ver_mas btn_cotizar">
